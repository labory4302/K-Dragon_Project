...
<script type="text/javascript">
        ...
        function checkValue()
        {
            ...
            if(form.userPassword.value != form.passwordcheck.value ){
        ...
        function confirmId(){
        	if(!document.userInfo.name.value){
 			...
 			url= "confirmId.jsp?name=" + encodeURI(document.userInfo.name.value);
 			open(url, "confirm",
 			"toolbar=no,location=no,status=no,scrollbars=no,resizable=no,width=300,height=200");
        }	
				...
				name="userInfo" onsubmit="return checkValue()">
					...
					<div class="form-group">
						<input type="text" class="form-control" placeholder="아이디"
							name="name" onkeydown="inputIdChk()" maxlength="20">
							<input type="hidden" name="idDuplication" value="idUncheck">
                     <input type="button" value="중복확인" name="confirm_id" onclick="confirmId(this.form)">
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호"
							name="userPassword" maxlength="20" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);">
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호"
							name="passwordcheck" maxlength="20" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);">
					</div>
					<div class="form-group">
